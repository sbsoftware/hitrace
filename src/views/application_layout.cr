...
class ApplicationLayout < ToHtml::Layout
  ...
  append_to_head Style, ApplicationStyle, HomeView::Style, LegalMenuView::Style, GameButton::Style, LeaderboardView::Style, GameGridView::Style, GameSummaryView::Style
